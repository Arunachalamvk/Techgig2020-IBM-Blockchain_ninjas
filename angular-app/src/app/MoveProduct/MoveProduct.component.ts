...
export class MoveProductComponent implements OnInit {
  ...
  addTransaction(form: any): Promise<any> {
    if(this.status.value === 'Negative'){
      this.myForm.controls['remarks'].setValue('Selfquarantined');
    }
    if(this.status.value === 'Positive'){
      this.myForm.controls['remarks'].setValue('Hospitalized');
    }
    if(this.status.value === 'Testing'){
      this.myForm.controls['remarks'].setValue('Testing');
    }
    this.Transaction = {
