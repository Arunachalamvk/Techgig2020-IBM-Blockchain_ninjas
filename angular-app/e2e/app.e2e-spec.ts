...
describe('Starting tests for angular-app', function() {
  ...
  it('network-name should be medi-trans@0.0.1',() => {
    element(by.css('.network-name')).getWebElement()
    .then((webElement) => {
      return webElement.getText();
    })
    .then((txt) => {
      expect(txt).toBe('medi-trans@0.0.1.bna');
    });
  });
  ...
  it('navbar-brand should be angular-app',() => {
    ...
    it('Medicine table should have 8 columns',() => {
      page.navigateTo('/Medicine');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('PO table should have 6 columns',() => {
      page.navigateTo('/PO');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('Hospital table should have 6 columns',() => {
      page.navigateTo('/Hospital');
      element.all(by.css('.thead-cols th')).then(function(arr) {
        expect(arr.length).toEqual(6); // Addition of 1 for 'Action' column
      });
    ...
    it('TransferCommodityHospital component should be loadable',() => {
      page.navigateTo('/TransferCommodityHospital');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('TransferCommodityHospital');
      });
    });
